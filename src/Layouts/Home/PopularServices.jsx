...
const PopularServices = () => {
    ...
    return (
        <div className='my-10 bg-teal-200 py-10 px-5'>
            ...
            {popularServices?.length > 0 ?
                <div className='card-container md:w-[80%] mx-auto mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5'>
                    {popularServices.map(service =>
                        <div key={service?.sequence_value} className='md:w-96 p-5 bg-white text-center hover:shadow-2xl  md:h-[450px] flex flex-col'>
                            <div className=' grow'>
