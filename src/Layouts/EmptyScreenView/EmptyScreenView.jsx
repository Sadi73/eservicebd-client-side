...
const EmptyScreenView = (props) => {
    return (
        <div style={{ height: '30vh' }} className='flex flex-col justify-center'>
            ...
            <p className='text-teal-500' style={{  fontWeight: 600, fontSize: '16px', textAlign: 'center', marginBottom: '0px' }}>
